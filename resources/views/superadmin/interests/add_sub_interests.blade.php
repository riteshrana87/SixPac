...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item">Add sub interest</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Add Sub Interest</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddSubInterest" id="frmAddSubInterest" method="POST" autocomplete="off" action="{{ route('store-sub-interests') }}">
					@csrf
						<div class="row">
							<div class="col-md-6">
								<div class="field mb-4">
                                    <label>Interest: <span class="req_star">*</span></label>
									<select class="form-control req" name="interest_name" id="interest_name" placeholder="Select interest name">
								...
								<div class="field mb-4">
									...
									<input class="form-control req" type="text" name="sub_interest_name" id="sub_interest_name" placeholder="Enter sub interest name" maxlength="70" value="{{ old('sub_interest_name') }}">
								</div>
