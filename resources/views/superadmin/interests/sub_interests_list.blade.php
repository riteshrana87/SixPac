...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item"><a href="{{ url('superadmin/interests') }}">Interest listing</a></li>
            <li class="breadcrumb-item">Sub interest listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Sub Interest Listing</h5>
                    <a href={{ url('superadmin/interests/sub-interests/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
                </div>


                <div class="sp_table">
                    <div class="table-responsive">
                        <table id="tblSubInterests" class="table table-bordered">
                            <thead>
		                        <tr>
		                            <th>Sub interest title</th>
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body no-top-border">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p class="modal-text">Are you sure you want to delete this sub interest?</p>
                </div>
	...
	<div class="modal-dialog modal-lg">
	  <div class="modal-content">
		<div class="modal-header">
		  <h4 class="modal-title">Sub interest details</h4>
