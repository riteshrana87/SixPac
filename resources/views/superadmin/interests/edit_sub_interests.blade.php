...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item"><a href="{{ url('superadmin/interests/sub-interests') }}">Sub interests</a></li>
            <li class="breadcrumb-item">Edit sub interest</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Edit Sub Interest</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmEditSubInterest" id="frmEditSubInterest" method="POST" autocomplete="off" action="{{ route('update-sub-interests') }}">
					@csrf
					@method('PUT')
						<input type="hidden" name="sub_interest_id" id="sub_interest_id" value="{{ $data->id }}">
						<div class="row">
							<div class="col-md-6">
								<div class="field mb-4">
                                    <label>Interest: <span class="req_star">*</span></label>
									<select class="form-control req" name="interest_name" id="interests_name" placeholder="Select interest name">
										<option value="">Select Interest</option>
										@foreach($interests as $interest)
										<option value="{{ $interest->id }}" @if($data->interest_id == $interest->id) selected @endif >{{ $interest->interest_name }}</option>
										@endforeach
									</select>
								</div>
								<div class="field mb-4">
                                    <label>Sub interest name: <span class="req_star">*</span></label>
									<input class="form-control req" type="text" name="sub_interest_name" id="sub_interest_name" placeholder="Enter sub interest name" maxlength="70" value="{{ $data->sub_interest_name }}">
								</div>
								...
								<div class="row">
									<div class="col-md-6 text-left">
										<a href={{ url('superadmin/interests/sub-interests') }}>
