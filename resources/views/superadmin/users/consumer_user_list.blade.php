...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('Consumer Users') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item">Consumer user listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-4">
							<h5 class="mb-0">Consumer User Listing</h5>
						</div>
						<div class="col-md-8 text-right">
							<button type="button" class="btnImport btn btn-secondary mr-4" id="importConsumerUser"><i class="fa fa-file-excel-o mr-2"></i>Import</button>
							<button type="button" class="btnExport btn btn-secondary mr-4" id="exportConsumerUser"><i class="fa fa-download mr-2"></i>Export</button>
							<a href={{ url('superadmin/users/consumer-users/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
						</div>
					</div>
                </div>
				...
				<form name="importUsers" id="importUsers" class="hide" method="POST" enctype="multipart/form-data" action="{{ route('import-consumer-user') }}">
                ...
                <div class="sp_table">
                    <div class="table-responsive">
                        <table id="tblConsumerUsers" class="table table-bordered">
                            <thead>
		                        <tr>
									<th>Id</th>
		                            <th>Name</th>
...
<!-- Delete consumer user code start here -->
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body no-top-border">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p class="modal-text">Are you sure you want to delete this consumer user?</p>
                </div>
...
<!-- Delete consumer user code end here -->

<!-- View consumer user code start here -->
<div class="modal fade viewDetails" id="viewDetails">
	<div class="modal-dialog modal-lg">
	  <div class="modal-content">
		<div class="modal-header">
		  <h4 class="modal-title">Consumer user details</h4>
...
<!-- View consumer user code end here -->
