...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('Consumer User') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item"><a href="{{ url('superadmin/users/consumer-users') }}">Consumer users</a></li>
            <li class="breadcrumb-item">Edit consumer user</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Edit Consumer User</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmEditConsumerUser" id="frmEditConsumerUser" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('update-consumer-user') }}">
					@csrf
					@method('PUT')
						...
						<div class="col-md-12 mt-4">
							<div class="row">
								<div class="col-md-6 text-left">
                                    <a href={{ url('superadmin/users/consumer-users') }}>
