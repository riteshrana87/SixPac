...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('Business Users') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item">Business user listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-4">
							<h5 class="mb-0">Business User Listing</h5>
						</div>
						<div class="col-md-8 text-right">
							<button type="button" class="btnImport btn btn-secondary mr-4" id="importBusinessUser"><i class="fa fa-file-excel-o mr-2"></i>Import</button>
							<button type="button" class="btnExport btn btn-secondary mr-4" id="exportBusinessUser"><i class="fa fa-download mr-2"></i>Export</button>
							<a href={{ url('superadmin/users/business-users/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
						</div>
					</div>
                </div>

				<a data-href="{{ $csvFile }}" id="downloadCsv" class="hide" >
					download
				</a>

				<form name="importUsers" id="importUsers" class="hide" method="POST" enctype="multipart/form-data" action="{{ route('import-business-user') }}">
                ...
                <div class="sp_table">
                    <div class="table-responsive">
                        <table id="tblBusinessUsers" class="table table-bordered">
                            <thead>
		                        <tr>
									<th>Id</th>
		                            <th>Name</th>
...
<!-- Delete business user code start here -->
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body no-top-border">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p class="modal-text">Are you sure you want to delete this business user?</p>
                </div>
...
<!-- Delete business user code end here -->

<!-- View business user code start here -->
<div class="modal fade viewDetails" id="viewDetails">
	<div class="modal-dialog modal-lg">
	  <div class="modal-content">
		<div class="modal-header">
		  <h4 class="modal-title">Business user details</h4>
...
<!-- View business user code end here -->
