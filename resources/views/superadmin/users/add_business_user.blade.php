...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item">Add business user</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Add Business User</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddBusinessUser" id="frmAddBusinessUser" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('store-business-user') }}">
					@csrf
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="field">
										...
										<input class="form-control req" type="text" name="company_name" id="company_name" placeholder="Enter company name" maxlength="70" value="{{ old('company_name') }}">
									</div>
								</div>							
                                ...
                                <div class="col-md-6">
									<div class="field">
										...
										<input class="form-control req" type="url" name="company_url" id="company_url" placeholder="Enter company url" maxlength="255" value="{{ old('company_url') }}">
									</div>
								</div>
