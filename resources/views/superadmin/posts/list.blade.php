...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('User\'s Posts') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item">User's post listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">User's Post Listing</h5>
                    <!--<a href="{{ url('superadmin/posts/add') }}"><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>-->
                </div>


                <div class="sp_table">
                    <div class="table-responsive">
                        <table id="tblPosts" class="table table-bordered">
                            <thead>
		                        <tr>
		                            <th>Id</th>
