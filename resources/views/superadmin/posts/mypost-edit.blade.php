        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmEditPosts" id="frmEditPosts" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('update-myposts') }}">
					@csrf
					@method('PUT')
