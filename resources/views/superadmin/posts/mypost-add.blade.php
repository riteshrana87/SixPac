...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('My Posts') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item"><a href="{{ url('superadmin/my-posts') }}">My posts</a></li>
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddPosts" id="frmAddPosts" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('superadmin.store-myposts') }}">
					@csrf
						<div class="row">
							<div class="col-md-6">
						...
						<div class="row">
							<div class="col-md-6 text-left">
								<a href={{ url('superadmin/my-posts') }}>
