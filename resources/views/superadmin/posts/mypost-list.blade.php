...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item">My Posts Listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">My Posts listing</h5>
                    <a href="{{ url('superadmin/my-posts/add') }}"><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
                </div>
