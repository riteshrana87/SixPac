@php $page_title = !empty($data->id) ? 'Edit Workout Type' : 'Add Workout Type'; @endphp
...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('Workout Type') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item"><a href="{{ url('superadmin/get-fit/workout-type') }}">Workout type</a></li>
            <li class="breadcrumb-item">{{ $type }} workout type</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">{{ $type }} Workout Type</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddEditWorkoutType" id="frmAddEditWorkoutType" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ empty($data) ? route('add-workout-type') : route('edit-workout-type',$data->id) }}">
					@csrf
					...
					<input type="hidden" name="id" id="id" value="{{ $data->id ?? null }}">
						<div class="row">
							<div class="col-md-6">
								<div class="field">
                                    <label>Workout type: <span class="req_star">*</span></label>
									<input class="form-control characterlimit req" max-character="70" type="text" name="name" id="name" placeholder="Enter workout type" maxlength="70" value="{{ $data->name ?? old('name') }}">
							...
							<div class="col-md-6">
                                ...
                                <input type="file" accept="image/x-png,image/jpeg" name="icon_file" id="workout_icon" class="hide">
							...
							<div class="row">
	                            <div class="col-md-6">
	                                <a href={{ url('superadmin/get-fit/workout-type') }}>
...
<script type="text/javascript" src="{{ asset('backend/assets/superadmin/js/manage_workout_type.js') }}" onload="add();"></script>
@endpush
