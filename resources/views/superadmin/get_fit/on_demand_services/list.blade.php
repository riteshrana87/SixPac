...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('On Demand Services') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item">On demand services listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <h5 class="mb-0">On Demand Services</h5>
                        </div>
                        <div class="col-md-8 text-right">
                            <a href={{ url('superadmin/get-fit/on-demand-services/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp_table">
                    <div class="table-responsive">
                        <table id="tblonDemandServices" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Service</th>
                                    <th>Getfit Category</th>
                                    <th>Created By</th>
                                    <th>Created Date</th>
                                    <th>Status</th>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Workout category details</h4>
...
<script type="text/javascript" src="{{ asset('backend/assets/superadmin/js/manage_on_demand_service.js') }}" onload="manage();"></script>
@endpush
