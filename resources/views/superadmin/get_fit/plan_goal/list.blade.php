...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item">Plan goal listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <h5 class="mb-0">Plan Goal</h5>
                        </div>
                        <div class="col-md-8 text-right">
                            <a href={{ url('superadmin/get-fit/plan-goal/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp_table">
                    <div class="table-responsive">
                        <table id="tblPlanGoals" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Id</th>
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body no-top-border">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p class="modal-text">Are you sure you want to delete this plan goal?</p>
                </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Plan goal details</h4>
...
<script type="text/javascript" src="{{ asset('backend/assets/superadmin/js/manage_plan_goal.js') }}" onload="manage();"></script>
@endpush
