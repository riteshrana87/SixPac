@php $page_title = !empty($data->id) ? 'Edit Equipment' : 'Add Equipment'; @endphp
...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('Equipment') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item"><a href="{{ url('superadmin/get-fit/equipment') }}">Equipment</a></li>
            <li class="breadcrumb-item">{{ $type }} equipment</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">{{ $type }} Equipment</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddEditEquipment" id="frmAddEditEquipment" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ empty($data) ? route('add-equipment') : route('edit-equipment',$data->id) }}">
					@csrf
					...
					<input type="hidden" name="id" id="id" value="{{ $data->id ?? null }}">
						<div class="row">
							<div class="col-md-6">
								<div class="field">
                                    <label>Equipment title: <span class="req_star">*</span></label>
									<input class="form-control characterlimit req" max-character="70" type="text" name="name" id="name" placeholder="Enter equipment title" maxlength="70" value="{{ $data->name ?? old('name') }}">
							...
							<div class="row">
	                            <div class="col-md-6">
	                                <a href={{ url('superadmin/get-fit/equipment') }}>
...
<script type="text/javascript" src="{{ asset('backend/assets/superadmin/js/manage_equipment.js') }}" onload="add();"></script>
@endpush
