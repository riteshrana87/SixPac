@php $page_title = !empty($data->id) ? 'Edit Plan Sport' : 'Add Plan Sport'; 
...
<div class="page-header card">
	<div class="card-block">
		<h5 class="m-b-10">{{ __('Plan Sport') }}</h5>
		<ul class="breadcrumb-title b-t-default p-t-10">
			<li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
			<li class="breadcrumb-item"><a href="{{ url('superadmin/get-fit/workout-type') }}">Plan sport</a></li>
			<li class="breadcrumb-item">{{$type}} plan sport</li>
		</ul>
	</div>
</div>
<!-- Page-header end -->
<div class="page-body">
		...
		<div class="col-sm-12">
			...
			<div class="card page-content">
				...
				<div class="card-body d-flex align-items-center justify-content-between">
					<h5 class="mb-0">{{$type}} Plan Sport</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
				</div>
				...
				<div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddEditPlanSport" id="frmAddEditPlanSport" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ empty($data) ? route('add-plan-sport') : route('edit-plan-sport',$data->id) }}">
						@csrf
						...
						<div class="row">
							<div class="col-md-6">
								<div class="field">
									<label>Plan Sport: <span class="req_star">*</span></label>
									<input class="form-control characterlimit req" max-character="70" type="text" name="name" id="name" placeholder="Enter plan sport title" maxlength="70" value="{{ $data->name ?? old('name') }}">
							...
							<div class="col-md-6">
								...
								<input type="file" accept="image/x-png,image/jpeg" name="icon_file" id="sport_icon" class="hide">
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-md-6">
										<a href={{ url('superadmin/get-fit/plan-sport') }}>
	...
	<script type="text/javascript" src="{{ asset('backend/assets/superadmin/js/manage_plan_sport.js') }}" onload="add();"></script>
	@endpush
