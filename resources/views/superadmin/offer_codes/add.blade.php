...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item">Add offer code</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Add Offer Code</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddOfferCode" id="frmAddOfferCode" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('store-offer-code') }}">
					@csrf
						<div class="row">
							<div class="col-md-6">
								<div class="field mb-4">
                                    <label>Offer code: <span class="req_star">*</span></label>
									<input class="form-control req" type="text" name="offer_code" id="offer_code" placeholder="Enter offer code" maxlength="70" value="{{ old('offer_code') }}">
								</div>
								<div class="field mb-4">
                                    <label>Discount: <span class="req_star">*</span></label>
									<input class="form-control numerordecimal req" type="text" name="discount" id="discount" placeholder="Enter discount(%)" maxlength="5" value="{{ old('discount') }}">
								</div>
								<div class="field mb-4">
                                    <label>Start date: <span class="req_star">*</span></label>
									<input class="form-control req" type="text" name="start_date" id="start_date" placeholder="Select start date" maxlength="10" value="{{ old('start_date') }}">
								</div>
								<div class="field mb-4">
                                    <label>End date: <span class="req_star">*</span></label>
									<input class="form-control req" type="text" name="end_date" id="end_date" placeholder="Select end date" maxlength="10" value="{{ old('end_date') }}">
								</div>
								<div class="field mb-4">
