...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item">Edit fitness status</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Edit Fitness Status</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmEditFitnessStatus" id="frmEditFitnessStatus" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('update-fitness-status') }}">
					@csrf
					@method('PUT')
						<input type="hidden" name="fitness_status_id" id="fitness_status_id" value="{{ $data->id }}">
						<div class="row">
							<div class="col-md-6">
								<div class="field mb-4">
                                    <label>Fitnetess status: <span class="req_star">*</span></label>
									<input class="form-control req" type="text" name="fitness_status" id="fitness_status" placeholder="Enter fiteness status" maxlength="70" value="{{ $data->fitness_status }}" maxlength="70">
								</div>
								<div class="field mb-4">
									@php
									if($data->status == 1){
