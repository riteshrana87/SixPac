...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item"><a href="{{ url('superadmin/offer-code') }}">Profanity word</a></li>
            <li class="breadcrumb-item">Add profanity word</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Add Profanity Word</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddProfanityWord" id="frmAddProfanityWord" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('superadmin.store-profanity-words') }}">
					@csrf
						<div class="row">
							<div class="col-md-6">
								<div class="field mb-4">
                                    <label>Profanity word: <span class="req_star">*</span></label>
									<input class="form-control req" type="text" name="profanity_word" id="profanity_word" placeholder="Enter profanity word" maxlength="20" value="{{ old('profanity_word') }}">
								</div>
								<div class="field mb-4">
