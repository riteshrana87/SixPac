...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('Profanity words') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item">Profanity word listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Profanity Word Listing</h5>
                    <a href={{ url('superadmin/profanity-words/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
                </div>


                <div class="sp_table">
                    <div class="table-responsive">
                        <table id="tblProfanityWord" class="table table-bordered">
                            <thead>
		                        <tr>
		                            <th>Sr No.</th>
		                            <th>Word</th>
...
<!-- Delete offercode code start here -->
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body no-top-border">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p class="modal-text">Are you sure you want to delete this word?</p>
                </div>
...
<!-- Delete offercode code end here -->
	...
	<div class="modal-dialog modal-lg">
	  <div class="modal-content">
		<div class="modal-header">
		  <h4 class="modal-title">Profanity word details</h4>
