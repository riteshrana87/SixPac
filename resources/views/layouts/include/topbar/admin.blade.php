<nav class="navbar header-navbar pcoded-header">
               <div class="navbar-wrapper">
                   ...
                   <div class="navbar-container container-fluid">
                       ...
                       <ul class="nav-right">
                           @php
                                $avtar_url = !empty(Auth::user()->avtar) ? Storage::disk(Config::get('constant.FILESYSTEM_CLOUD'))->url(Config::get('constant.USER_ORIGINAL_PHOTO_UPLOAD_PATH').Auth::user()->avtar) : asset('backend/assets/images/no-avtar.png');
                           @endphp
