...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item">Exercise listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 text-right">
                            <a href={{ url('business/get-fit/exercises/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body no-top-border">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p class="modal-text">Are you sure you want to delete this exercise?</p>
                </div>
...
<script type="text/javascript" src="{{ asset('backend/assets/business/js/manage_exercise.js') }}" onload="manage()"></script>
@endpush
