        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Add Product Category</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddProductCategory" id="frmAddProductCategory" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('business.store-product-category') }}">
					@csrf
						<div class="row">
							<div class="col-md-6">
								<div class="field mb-4">
                                    <label>Product category: <span class="req_star">*</span></label>
									<input class="form-control characterlimit req" max-character="70" type="text" name="category_name" id="category_name" placeholder="Enter product category" maxlength="70" value="{{ old('product_category') }}">
									<span class="pull-right label label-default count_message_field" id="cm_category_name">0 / 70</span>
								</div>
								<div class="field mb-4">
