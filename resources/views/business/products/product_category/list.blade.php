...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item">Product category listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Product Category Listing</h5>
                    <a href={{ url('business/products/product-category/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
                </div>


                <div class="sp_table">
                    <div class="table-responsive">
                        <table id="tblProductCategory" class="table table-bordered">
                            <thead>
		                        <tr>
		                            <th>Category name</th>
		                            <th>Created date</th>
...
<!-- Delete product category code start here -->
...
<!-- Delete product category code end here -->

<!-- View product category code start here -->
...
<!-- View product category code end here -->
@endsection
