				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-8 text-right">
							<a href={{ url('business/posts') }}><button type="button" class="btnImport btn btn-secondary mr-4"><i class="fa fa-angle-double-left mr-2"></i>Back to Posts</button></a>
							<button type="button" class="btn btn-info" id="btnAddComment" data-post_id="{{ $postId }}" data-url="{{ url('business/posts/comments/add') }}"><i class="fa fa-plus mr-2"></i>Add Comment</button>
						</div>
					</div>
                </div>
