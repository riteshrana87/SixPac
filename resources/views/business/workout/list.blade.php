...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('Workout') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item">Workout listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <h5 class="mb-0">Workout</h5>
                        </div>
                        <div class="col-md-8 text-right">
                            <a href={{ url('business/get-fit/workout/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body no-top-border">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p class="modal-text">Are you sure you want to delete this workout?</p>
                </div>
...
<script type="text/javascript" src="{{ asset('backend/assets/business/js/manage_workout.js') }}" onload="manage()"></script>
@endpush