        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-block">
					...
					<form class="form-horizontal spform" name="frmEditProfile" id="frmEditProfile" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('business.updateProfile', $data->id) }}">
					@csrf
					@method('PUT')
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="field">
											...
											<input class="form-control req" type="text" name="user_name" id="user_name" placeholder="Enter user name" maxlength="50" value="{{ $data->user_name }}">
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="field">
											...
											<input class="form-control req" name="company_name" id="company_name" type="text" placeholder="Enter your company name" value="{{ $company_name }}" maxlength="70">
										</div>
									</div>
