...
<div class="page-header card">
    <div class="card-block">
        ...
        <ul class="breadcrumb-title b-t-default p-t-10">
            ...
            <li class="breadcrumb-item">Add employee user</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Add Employee User</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmAddEmployeeUser" id="frmAddEmployeeUser" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('store-employee-user') }}">
					@csrf
							...
							<div class="row">
								<div class="col-md-6">
									<div class="field">
										...
										<input class="form-control req" type="text" name="name" id="name" placeholder="Enter employee name" maxlength="40" value="{{ old('name') }}">
									</div>
								</div>
								<div class="col-md-6">
									<div class="field">
								...
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-3">
											<div class="field">
												<label>City:</label>
												<input class="form-control req city-autocomplete" type="text" name="city_name"  id="city_name" placeholder="Enter city" autocomplete="off" data-url="{{ url ('business/settings/getCityList/{query}') }}">
