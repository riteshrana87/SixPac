...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('Employee User') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item"><a href="{{ url('business/users/employee-users') }}">Employee users</a></li>
            <li class="breadcrumb-item">Edit employee user</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
        ...
        <div class="col-sm-12">
            ...
            <div class="card page-content">
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Edit Employee User</h5><span>All fields (<span class="req_star">*</span>) are required.</span>
                </div>
                ...
                <div class="card-block table-border-style">
					...
					<form class="form-horizontal spform" name="frmEditEmployeeUser" id="frmEditEmployeeUser" method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('update-employee-user') }}">
					@csrf
					@method('PUT')
							...
							<div class="row">
								<div class="col-md-6">
									<div class="field">
										...
										<input class="form-control req" type="text" name="name" id="name" placeholder="Enter employee user name" maxlength="70" value="{{ $data->name }}">
									</div>
								</div>
								<div class="col-md-6">
									<div class="field">
								...
								<div class="col-md-12">
									<div class="field">
										<label>Address: </label>
										<input class="form-control req" type="text" name="address" id="address" placeholder="Enter address" maxlength="255" value="{{ $address }}">
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-3">
											<div class="field">
												<label>City:</label>
												<input class="form-control req city-autocomplete" type="text" placeholder="Enter city" name="city_name"  id="city_name" value="{{ $city_name }}" autocomplete="off" data-url="{{ url ('business/settings/getCityList/{query}') }}">
						...
						<div class="col-md-12 mt-4">
							<div class="row">
								<div class="col-md-6 text-left">
									<a href={{ url('business/users/employee-users') }}>
