...
<div class="page-header card">
    <div class="card-block">
        <h5 class="m-b-10">{{ __('Workout Plan') }}</h5>
        <ul class="breadcrumb-title b-t-default p-t-10">
            <li class="breadcrumb-item"><a href="{{ url('/') }}"> <i class="fa fa-home"></i> </a></li>
            <li class="breadcrumb-item">Workout plan listing</li>
        </ul>
    </div>
</div>
<!-- Page-header end -->
            ...
            <div class="card page-content">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 text-right">
                            <a href={{ url('business/get-fit/workout-plan/add') }}><button type="button" class="btn btn-info"><i class="fa fa-plus mr-2"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="sp_table">
                    <div class="table-responsive">
                        <table id="tblExercises" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th class="no-sort">Poster Image</th>
                                    <th>Plan Title</th>
                                    <th>Duration</th>
                                    <th>Created Date</th>
                                    <th>Status</th>
        ...
        <form action="" id="deleteForm" method="post">
            <div class="modal-content">
                ...
                <div class="modal-body no-top-border">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <p class="modal-text">Are you sure you want to delete this workout plan?</p>
                </div>
...
<script type="text/javascript" src="{{ asset('backend/assets/business/js/manage_workout_plan.js') }}" onload="manage()"></script>
@endpush
