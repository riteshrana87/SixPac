...
$("body").on("click", "#pf_edit, #pf_upload_icon", function () {
    $("#sport_icon").trigger("click");
});

$("#sport_icon").on("change", function () {
    ...
    if (extn == "png" || extn == "jpg" || extn == "jpeg") {
        if (typeof FileReader != "undefined") {
            var uploadedFile = document.getElementById("sport_icon");
...
function manage() {
    var table = $("#tblPlanSports").DataTable({
        processing: true,
        serverSide: true,
        ajax: superadmin_url + "/get-fit/plan-sport",
        order: [[0, "desc"]],
        columns: [
            { data: "id", name: "id" },
        ...
        columnDefs: [
            ...
            { targets: 3, searchable: false, className: "text-left" },
...
function add() {
    ...
    var form = $("form[name='frmAddEditPlanSport']");
    $("#btnSubmit").click(function (e) {
        ...
        form.validate({
            ...
            messages: {
                name: {
                    required: "The plan sport is required.",
                    minlength:
                        "Plan sport minimum length should be 4 character.",
                    maxlength:
                        "Plan sport maximum length should be 40 character.",
                },
                //  getfit_id:{
                //     required: 'The getfit type is required.'
                // },
                icon_file: {
                    required: "Please select plan sport icon.",
                },
            },
        });
        if (form.valid()) {
