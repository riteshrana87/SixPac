...
class WorkoutTypeRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|min:4|max:70|unique:workout_types,name,'.$this->id,
    ...
    {
        return [
            'name.required' => 'The workout type is required.',
            'name.min' => 'The workout type must be at least 4 characters.',
            'name.max' => 'The workout type must not be greater than 70 characters.',
            'name.unique' => 'The workout type has already been taken.',
