...
class RegisterResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'bannerPic' => !empty($this->banner_pic) ? Storage::disk(Config::get('constant.FILESYSTEM_CLOUD'))->url($bannerOriginalImagePath.$this->banner_pic) : asset('admin/images/faces/pic-1.png'),
            'thumbBannerPic' => !empty($this->banner_pic) ? Storage::disk(Config::get('constant.FILESYSTEM_CLOUD'))->url($bannerThumbImagePath.$this->banner_pic) : asset('admin/images/faces/pic-1.png'),
