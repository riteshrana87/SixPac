...
class PostCommentResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'profilePic' => !empty($this->usersInfo->avtar) ? Storage::disk(Config::get('constant.FILESYSTEM_CLOUD'))->url($OriginalImagePath.$this->usersInfo->avtar) : asset('admin/images/faces/pic-1.png'),
            'thumbProfilePic' => !empty($this->usersInfo->avtar) ? Storage::disk(Config::get('constant.FILESYSTEM_CLOUD'))->url($ThumbImagePath.$this->usersInfo->avtar) : asset('admin/images/faces/pic-1.png'),
            ...
            'comment_down_vote_count' => $this->comment_down_vote_count,
