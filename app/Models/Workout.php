...
class Workout extends Model
{
    ...
    protected $fillable = [
        'name','workout_type_id','duration_id','poster_image',
        'video_name','video_thumb','overview','created_by','status'
    ];
    ...
    /**
     * duration is used to get workout type
     *
     * @return \Illuminate\Http\Eloquent\belongsTo
     * @author Spec Developer
     */
    public function duration() {
        return $this->belongsTo(ExerciseDuration::class);
    }
    ...
    {
        return $this->morphedByMany(Equipment::class, 'workoutable');
    }

    public function bodyParts()
    {
        return $this->morphedByMany(BodyParts::class, 'workoutable');
    }

    public function exercises()
    {
        return $this->morphedByMany(Exercise::class, 'workoutable');
    }

    public function fitnessLevels()
    {
        return $this->morphedByMany(FitnessLevel::class, 'workoutable');
    }
