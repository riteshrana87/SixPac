...
class VideoService
{
    ...
    public function save($file, $params)
    {
        ...
        try {
            ...
            $storage->put($originalPath, file_get_contents($this->file), 's3');
        ...
        return [
            ...
            'thumb_file_name' => $response['thumb_file_name'],
            'video_file_name' => $tempFileName,
    ...
    public function getInfo()
    {
        try {
            $info = [
                ...
                'filesize' => Storage::disk('s3')->size($this->filePath),
            ];
